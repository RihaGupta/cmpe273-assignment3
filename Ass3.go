...
func (pe *LocPrice) get(c *Client) error {
...
func createlocation(rw http.ResponseWriter, req *http.Request, p httprouter.Params) {
	...
	conn, err := mgo.Dial("mongodb://riha:rudransh@ds053838.mongolab.com:53838/uberpricing")
    if err != nil {
        panic(err)
    }
    defer conn.Close();
	conn.SetMode(mgo.Monotonic,true);
	c:=conn.DB("uberpricing").C("location");
	err = c.Insert(t);
...
///UBERRRRRR !!!!
    ...
    options.ServerToken= "9fLr45PFWzfGKB2sIyUDV6MZG3juQzcQlZhrRj2w";
    options.ClientId= "Z7GgZVqKuZV3Cdw03u6yH3csoh5wzw6q";
    options.ClientSecret= "WPuZOJWnPfSOCcWqlIIVc4GFXKOGB-o1LIGKseqR";
    options.AppName= "CMPE273APP";
    ...
    tripId=tripId+1;
     ...
     c1:=conn.DB("uberpricing").C("Price");
...
func requesttrip(rw http.ResponseWriter, req *http.Request, p httprouter.Params){
    ...
    url := fmt.Sprintf(APIUrl, "requests?","eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..jJNWJK8kATMOTnm5Zi_o2kdC2xnYPz4aXQvbAjpPuAQlHdXvvgTAtZXbfV3GwIKjw5NIuTfzDi99swg42DB20OnePuVkUvoOKxUSChsnmx0co8w7UeDN7JAY43QlQu_oLIuJjmJ7pFfPPPX_s49M7XcgsnHIPvmBRdHvoaiexaGm3_XIZNSnCUSZe4VCd_MZzgRsXWO5Zlqk9jW61H5JFJMJkv6kASojRh4qMGqr-VlRcJoTz2wNxnTx2HyEIpgzUj4PE_fkddOkX1oLhNyUlmDAagjxrWAJrwWe7ApSQnpk58NfMfjulwlWpZdHuAj-Bd2bE1qRTaMW-YzX3vAPfw")
